...
import org.rapidpm.vaadin.trainer.api.UserServiceInMemory;
...
//  private final Instance<MainView> mainViewSupplier =
...
//        current.setContent(Main.weldContainer.select(MainView.class).get());
      }
      else {
